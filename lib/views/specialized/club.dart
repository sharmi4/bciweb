...
''')
            ...
            ksizedbox30,
            Container(child: Row(children: [Container(child: Column(children: [Text('Set out with us from your courtyard at IXORA, to explore the nature India.;')  .text
                          .xl5
                          .bold
                          .blue900
                          .tight
...
* Developing an all round personality with leadership and cultural    skills of art and fine arts. ''').text
                          .semiBold
                          .xl2
                          .thin
                          .blue900
                          .heightLoose
                          .make()],),
              width: size.width*0.5),Image.asset('assets/images/specialized/Image 36.png')],),
              width: size.width,
              height: 500,
