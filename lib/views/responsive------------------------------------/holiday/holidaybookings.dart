...
import 'package:bciweb/views/responsive------------------------------------/holiday/widgets/additional_info.dart';
import 'package:bciweb/views/responsive------------------------------------/holiday/widgets/day_wise_itnerary.dart';
import 'package:bciweb/views/responsive------------------------------------/holiday/widgets/enquiry_now.dart';
import 'package:bciweb/views/responsive------------------------------------/holiday/widgets/hoteldetails.dart';
import 'package:bciweb/views/responsive------------------------------------/holiday/widgets/overview.dart';
