...
class MobVendorsCategoryListView extends StatefulWidget {
  String vendorId;
  MobVendorsCategoryListView({super.key, required this.vendorId});

  @override
  State<MobVendorsCategoryListView> createState() => _VendorsListViewState();
}

class _VendorsListViewState extends State<MobVendorsCategoryListView> {
                  ...
                  return Padding(
                    ...
                    child: InkWell(
                      onTap: () {
                        ...
                        //   ),
                        // );
                        Get.to(() => ResVendorServiceListScreen(
