                          ...
                          children: [
                            Padding(
                              ...
                              child: holidayPackageController
                                  ...
                                  : Image.network(holidayPackageController
                                      .getPackageDetailsData.first.image),
                            ),
                            ksizedbox10,
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            ...
                            holidayPackageController
                                ...
                                : HtmlContentViewer(
                                    htmlContent: holidayPackageController
                                        .getPackageDetailsData.first.exclusion,
                                    initialContentHeight:
                                        MediaQuery.of(context).size.height,
                                    initialContentWidth:
                                        MediaQuery.of(context).size.width,
                      ...
                      Container(
                          ...
                          child: Column(children: [
                            Padding(
                              ...
                              child: holidayPackageController
                                      .getPackageDetailsData.isEmpty
                                  ? Image.asset('assets/images/munnar1.jpg')
                                  : Image.network(holidayPackageController
                                      .getPackageDetailsData.first.image),
                            ),
                            Padding(
                      ...
                      Container(
                          ...
                          child: Column(children: [
                            Padding(
                                ...
                                child: holidayPackageController
                                        .getPackageDetailsData.isEmpty
                                    ? Image.asset('assets/images/munnar2.jpg')
                                    : Image.network(holidayPackageController
                                        .getPackageDetailsData.first.image)),
                            Padding(
                              padding: const EdgeInsets.only(left: 10, top: 17),
                      ...
                      Container(
                          ...
                          child: Column(children: [
                            Padding(
                                ...
                                child: holidayPackageController
                                        .getPackageDetailsData.isEmpty
                                    ? Image.asset('assets/images/munnar3.jpg')
                                    : Image.network(holidayPackageController
                                        .getPackageDetailsData.first.image)),
                            Padding(
                              padding: const EdgeInsets.only(left: 10, top: 17),
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(color: kwhite, fontSize: 18.5),
                            ),
                            Padding(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    Icon(Icons.flight_sharp, color: kgrey),
                                    Icon(Icons.hotel, color: kgrey),
                                    Icon(Icons.explore, color: kgrey),
                                    Icon(Icons.car_crash, color: kgrey),
                                    Icon(Icons.set_meal, color: kgrey)
                                  ]),
                            ),
                            Padding(
                              padding: const EdgeInsets.only(left: 10),
