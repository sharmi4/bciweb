                         ...
                         width: MediaQuery.of(context).size.width*0.57,
                                  ...
                                  child: Column(
                                    children: [
                                      Padding(
                                        padding: const EdgeInsets.only(left: 10,right: 10),
                                        child:holidayPackageController.getPackageDetailsData.isEmpty? Image.asset(
                                          'assets/images/overviewimage.png'
                                        ):Image.network(holidayPackageController.getPackageDetailsData.first.image),
                                      ),
                                      ksizedbox10,
                                      Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          Padding(
                                            ...
                                            child:holidayPackageController.getPackageDetailsData.isEmpty?Text('No Data'): Text(holidayPackageController.getPackageDetailsData.first.title,
                                            style: TextStyle(
                                              fontSize: 17,
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            style: TextStyle(
                                              color: korange,
                                              fontWeight: FontWeight.bold
                                            ),):Text(holidayPackageController.getPackageDetailsData.first.title),
                                            Row(
                                              children: [
                                                Icon(Icons.star,
                                                color: kyellow,),
