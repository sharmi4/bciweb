            ...
            Stack(
              children: [
                ...
                left: 400,
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text('3  STEPS  OR  THE  PERFECT  CLUB',style: TextStyle(fontSize: 22,color: kOrange),),
                       Padding(
                         padding: const EdgeInsets.only(top: 9),
                         child: Text('FIND  BEST  MEMBERSHIPS',
                         style: TextStyle(fontSize: 33,color: kblue,fontWeight: FontWeight.bold),),
                       ),
                  ],
                ),
             ...
             Positioned(
              ...
              child:Column(
                 ...
                 children: [
                   Text('To find the best membership programs, it"s important to consider what you"re ',
                   style: TextStyle(fontSize: 17),),
                   Padding(
                     padding: const EdgeInsets.only(top: 6),
                     child: Text('looking for in a membership. Here are some general tips to help you find a',
                     style: TextStyle(fontSize: 17),),
                   ),
                   Padding(
                     padding: const EdgeInsets.only(top: 6),
                     child: Text('membership that suits your needs:',style: TextStyle(fontSize: 17),),
                   )
                 ],
               ), ),
               Positioned(
                ...
                children: [
                  Row(
                    ...
                    Padding(
                      ...
                      child: Image.asset('assets/images/bazarimage.png'),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(left: 240),
                      child: Image.asset('assets/images/serviceimage.png'),
                    )
                    ],
                  ),
                  Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text('HOTELS & SERVICES',
                        style: TextStyle(color: kblue,fontSize: 17,fontWeight: FontWeight.bold),),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(left: 180,top:20),
                        child: Text('ESSENTIAL BAZZAR',
                        style: TextStyle(color: kblue,fontSize: 17,
                        fontWeight: FontWeight.bold),),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(left: 120,top: 20),
                        child: Text('A TO Z UTILITY SERVICE & \n    ONLINE DISCOUNTS',
                        style: TextStyle(color: kblue,fontSize: 17,fontWeight: FontWeight.bold),),
                      )
                    ],
                  ),
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Padding(
                    ...
                    child: Image.asset('assets/images/homebackground2.png',height: 400,),
                  ))
              ],
            ),
           ...
           Padding(
             ...
             child: Stack(
              ...
              Positioned(
                ...
                Positioned(
                  left: 400,
                  top: 180,
                  child: Text('Adding booking services to your website or app can help streamline your business \n         and make it easier for your customers to book your services',
                            ...
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.only(top: 30),
                                    child: Text('WORLD CLASS SERVICE',
                                    style: TextStyle(fontSize: 15,color: kblue),),

                                  ),
                                  Padding(
                                    padding: const EdgeInsets.only(left: 10,top: 15),
                                    child: Text('World-class service refers to exceptional and unparalleled service quality that sets a business apart from its competitors.',
                            ...
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.only(top: 30),
                                    child: Text('BEST PRICE GUARANTEE',
                                    style: TextStyle(fontSize:15,color: kblue ),),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.only(left: 10,top: 15),
                                    child: Text('A best price guarantee is a promise made by a business or service provider to offer the lowest possible price for their product or service.',style: TextStyle(
                                      fontSize: 12
                                    ),),
                                  )
                                ],
                        ...
                        Padding(
                          ...
                          child: CircleAvatar(
                            radius: 25,
                                            ...
                                            child: Image.asset('assets/icons/starbutton.png',
                  ...
                  Padding(
                    ...
                    child: CircleAvatar(
                      radius: 25,
                      backgroundColor: kOrange,
                      child: Image.asset('assets/icons/worldbutton.png',height: 25,fit: BoxFit.fitHeight,),
                    ),
                  ),
                                    Padding(
                                      ...
                                      child: CircleAvatar(
                                        radius: 25,
                                                        backgroundColor: kOrange,
                                                        child: Image.asset('assets/icons/likebutton.png',height: 25,fit: BoxFit.fitHeight,),
                                                      ),
                                    )
                    ],
                  ))
             ...
             Stack(
              ...
              Positioned(
                top: 80,
                left: 50,
                child: Image.asset('assets/images/homebackgroundimage.png',
                height: 450,fit: BoxFit.fitHeight,)),
                Positioned(
                  left: 0,
                  right: 0,
                  top: 160,
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text('FIND  BEST  BUSINESS',
                      style: TextStyle(fontSize: 35,fontWeight: FontWeight.bold,color: kblue),),
                    ),
                    Padding(
                    ...
                    Padding(
                      ...
                      child: Text('Starting a business requires financial investment. Consider the \n  potential costs, profits, and funding options for your business.',
                      style: TextStyle(fontSize: 17),),
                    ),
                    Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.end,
                        children: [
                          Text('THE ORIGINAL VISION',
                          style: TextStyle(fontSize:16.5,color: kblue,
                          fontWeight: FontWeight.bold ),),
                          Padding(
                             padding: const EdgeInsets.only(left: 10),
                             child: Container(
                    ...
                    Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text('INCREASE ONBOARDING SPEEDY BUSINESS',
                          style: TextStyle(fontSize: 16.5,color: kblue,
                          fontWeight: FontWeight.bold),),
                           Padding(
                             padding: const EdgeInsets.only(left: 10),
                     ...
                     Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text('VENDOR FOCUS 2 INCREASE SALES',
                          style: TextStyle(fontSize: 16.5,color: kblue,
                          fontWeight: FontWeight.bold),),
                          Padding(
                             padding: const EdgeInsets.only(left: 10),
                    ...
                    Padding(
                     ...
                     Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text('CUSTOMIZE YOUR BRAND & VALUE',
                          style: TextStyle(fontSize: 16.5,color: kblue,
                          fontWeight: FontWeight.bold),),
                          Padding(
                             padding: const EdgeInsets.only(left: 10),
             ...
             Stack(children:[ Container(
              ...
              width: MediaQuery.of(context).size.width,
              child: Image.asset('assets/images/homebackground5.png',fit: BoxFit.cover,)),
              Positioned(
                top: 0,
                left: 160,
                child: Column(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.end,
                    children: [
                      Text('Paid Ads Avalibales',style: TextStyle(fontSize:42,fontWeight: FontWeight.bold,color: kblue ),),
                    ],
                  ),
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: (){}, 
                        child: Text('Click Now',style: TextStyle(fontSize: 20),))
                      ],
                    ),
                  )
                ],
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text('TESTIMONIALS',style: TextStyle(color: kOrange,fontSize: 30,
                          ),),
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child: Text('What Our Clients Say About Us',style: TextStyle(fontSize: 30),),
                    ),
                    Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      Padding(
                                        ...
                                        child: Image.asset('assets/images/rajarani.png'),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(top: 8),
                                        child: Text('Raja Rani',
                                        style: TextStyle(fontSize: 15,color: kblue),),
                                      ),
                                      Padding(
                                      ...
                                      Padding(
                                        ...
                                        child: Image.asset('assets/icons/reviewstar.png'),
                                      )
                                    ],
                                  ),
                                ),
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                    Padding(
                                      padding: const EdgeInsets.only(top: 15),
                                      child: Image.asset('assets/images/sunda.png'),
                                    ),
                                    Padding(
                                      padding: const EdgeInsets.only(top: 10),
                                      child: Text('Sunda',
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Image.asset('assets/images/waveimage.png',
                        ...
                        Padding(
                          ...
                          child: Image.asset('assets/images/playgoogle.png',height: 150,fit:BoxFit.fitHeight,),
                        )
