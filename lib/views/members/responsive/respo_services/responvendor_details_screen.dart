...
import 'package:bciweb/views/members/responsive/respo_services/view_vendor_services_list.dart';
              ...
              child: Column(
                ...
                children:[ GetBuilder<HomeServiceController>(builder: (_) {
                  ...
                  InkWell(
                    onTap: () {
                      Get.to(
                        () => ResVendorServiceListScreen(vendorId: widget.vendorListModelData.id.toString(), ),
                      );
                    },
                    child: Container(
                      height: 50,
