...
class ResponsiveAboutScreen extends StatefulWidget {
  const ResponsiveAboutScreen({super.key});

  @override
  State<ResponsiveAboutScreen> createState() => _ResponsiveAboutScreenState();
}

class _ResponsiveAboutScreenState extends State<ResponsiveAboutScreen> {
  @override
