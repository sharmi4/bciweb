...
import 'package:bciweb/views/members/responsive/respo_services/widgets/resprofile/offers_screen.dart';
import 'package:bciweb/views/members/responsive/respo_services/widgets/resprofile/partner_screen.dart';
import 'package:bciweb/views/members/responsive/respo_services/widgets/resprofile/referal_screen.dart';
import 'package:bciweb/views/members/responsive/respo_services/widgets/resprofile/suport_screen.dart';
import 'package:bciweb/views/members/responsive/respo_services/widgets/resprofile/yours_coupons_screen.dart';
                            ...
                            mainAxisAlignment: MainAxisAlignment.center,
                             children: [
                              OutlinedButton(
                                style: ButtonStyle(
                                  padding: MaterialStateProperty.all(
                  const EdgeInsets.symmetric(vertical: 10, horizontal: 95)),
                  shape: MaterialStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(30.0))),
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    children: [Image.asset('assets/icons/profiledashboard.png',
                            ...
                            mainAxisAlignment: MainAxisAlignment.center,
                             children: [
                              OutlinedButton(
                                style: ButtonStyle(
                                  padding: MaterialStateProperty.all(
                  const EdgeInsets.symmetric(vertical: 10, horizontal: 104)),
                  shape: MaterialStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(30.0))),
                                ...
                                child: Row(
                                  ...
                                  children:[
                                     Padding(
                                       ...
                                       child: Image.asset('assets/icons/profilecuopons.png',
                                ...
                                child: Row(
                                  ...
                                  children:[ 
                                    Padding(
                                      ...
                                      child: Image.asset('assets/icons/proaditionaloffer.png',
                                                                      height: 35,fit: BoxFit.fitHeight,color: kblue,),
                                    ),
                                     Padding(
                                 padding: const EdgeInsets.only(left: 11),
                  ...
                  shape: MaterialStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(30.0))),
                                ...
                                child: Row(
                                  ...
                                  children:[ Padding(
                                    ...
                                    child: Image.asset('assets/icons/profilerefferal.png',
                            ...
                            mainAxisAlignment: MainAxisAlignment.center,
                             children: [
                              OutlinedButton(
                                style: ButtonStyle(
                                  padding: MaterialStateProperty.all(
                  const EdgeInsets.symmetric(vertical: 15, horizontal: 91)),
                  shape: MaterialStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(30.0))),
                                ...
                                child: Row(
                                  ...
                                  children:[ Padding(
                                    ...
                                    child: Image.asset('assets/icons/profilepartner.png',
                                    height: 25,fit: BoxFit.fitHeight,color: kblue,),
                                  ),
                                   Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                        Padding(
                                          ...
                                          child: Image.asset('assets/icons/profileupgrade.png',
                                                                      height: 32,fit: BoxFit.fitHeight,color: kblue,),
                                        ),
                               Padding(
                                 padding: const EdgeInsets.only(right: 15),
                                 child: Text('Upgrade',
                  ...
                  shape: MaterialStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(30.0))),
                                ...
                                child: Row(
                                  ...
                                  children:[ Padding(
                                    ...
                                    child: Image.asset('assets/icons/profilesubort.png',
                                    height: 35,fit: BoxFit.fitHeight,color: kblue,),
                                  ),
                                  Padding(
                  ...
                  const EdgeInsets.symmetric(vertical: 13, horizontal: 100)),
                                ...
                                child: Row(
                                  ...
                                  children:[
                                     Padding(
                                       padding: const EdgeInsets.only(right: 15),
                                       child: Image.asset('assets/icons/profilelogout.png',
                                                                       height: 28,fit: BoxFit.fitHeight,color: kblue,),
                                     ),
                                  Padding(
                                 padding: const EdgeInsets.only(right: 25),
