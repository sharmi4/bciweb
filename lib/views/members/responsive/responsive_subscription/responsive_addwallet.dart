...
class ResponsiveAddWallet extends StatelessWidget {
  const ResponsiveAddWallet({super.key});
    ...
    return Scaffold(
      body: ListView(
        children: [
          ...
          Image.asset(
            'assets/images/wallet.png', height: size.height * 0.2,
          ...
          Text(
            ...
            textAlign: TextAlign.center,
            style: TextStyle(
                color: kblue, fontSize: 16, fontWeight: FontWeight.w700),
          ),
          ksizedbox30,
          Row(
