...
class _BusinessProfileSettingsState extends State<BusinessProfileSettings> {
  ...
  setDefauld() async {
    ...
    if (businessprofileController.profileData.isNotEmpty) {
      ...
      emailController.text = businessprofileController.profileData.first.email;
       categoryController.text =businessprofileController.profileData.first.category;
      ...
      mapurlController.text =businessprofileController.profileData.first.locationAddress.toString();   
    }
  }
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Obx(()=> businessprofileController.isLoading.isTrue ? Center(
