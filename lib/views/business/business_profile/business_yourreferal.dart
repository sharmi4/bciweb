...
class BusinessProfileReferal extends StatefulWidget {
  const BusinessProfileReferal({super.key});

  @override
  State<BusinessProfileReferal> createState() => _BusinessProfileReferalState();
}

class _BusinessProfileReferalState extends State<BusinessProfileReferal> {
