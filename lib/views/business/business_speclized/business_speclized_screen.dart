...
import 'package:bciweb/views/members/specialized/explor.dart';
import 'package:bciweb/views/members/specialized/club.dart';
...
import 'business_spclizedclub.dart';
import 'business_speclizedexplore.dart';

class BusinessSpecializedScreen extends StatefulWidget {
  // ignore: constant_identifier_names
  static const Namedroutes = '/specializedscreen';

  @override
  State<BusinessSpecializedScreen> createState() => _BusinessSpecializedScreenState();
}

class _BusinessSpecializedScreenState extends State<BusinessSpecializedScreen> {
                  ...
                  children: [
                    Column(
                      children: [
                        InkWell(
                          onTap: () {
                            Get.to(BusinessSpecializedClub());
                          },
                          child: ClipRRect(
                    ...
                    Column(
                      children: [
                        InkWell(
                          onTap: () {
                            Get.to(BusinessSpecializedExplore());
                          },
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(15),
                            child: Image.asset(
