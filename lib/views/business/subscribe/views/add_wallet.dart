...
class AddWallet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      Row(
        ...
        children: [
          ...
          Text(
            ...
            textAlign: TextAlign.center,
            style: TextStyle(color: kblue, fontSize: 22,fontWeight: FontWeight.w600),
          ),
          ksizedbox30,
          Container(
            child: Center(
      ...
      ksizedbox40,
      Text(
        'Others Amounts',textAlign: TextAlign.center,
        style: TextStyle(color: kblue,fontSize: 22, fontWeight: FontWeight.w700),
      ),
      ksizedbox30,
      Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
