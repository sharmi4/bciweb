                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      decoration:
                          BoxDecoration(color: korange, boxShadow: <BoxShadow>[
                        BoxShadow(
                          blurRadius: 3,
                        ...
                        onTap: () {
                          if (authprofileController
                              ...
                              authprofileController
                                      .profileData.first.bankAccountName !=
                                  "" &&
                              authprofileController
                                      .profileData.first.ifscCode !=
                                  "") {
                            Get.to(
                                () => const EnterAmountForWithdrawalScreen());
                          } else {
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Column(children: [
                    ...
                    GetBuilder<ApiSettingController>(builder: (_) {
                      return apisettingController.transactionhistorydata.isEmpty
                          ? Container(
                              child: Column(
                                  ...
                                  children: [
                                    Image.asset(
                                      'assets/images/nowalletimage.png',
                                      height: 300,
                                      fit: BoxFit.fitHeight,
                                    ),
                                    ksizedbox30,
                          ...
                          : ListView.builder(
                              shrinkWrap: true,
                              itemCount: apisettingController
