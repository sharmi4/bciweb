...
class BusinessCreateCouponsScreen extends StatefulWidget {
  ...
  @override
  State<BusinessCreateCouponsScreen> createState() =>
      _BusinessCreateCouponsScreenState();
}

class _BusinessCreateCouponsScreenState
    extends State<BusinessCreateCouponsScreen> {
  @override
  void initState() {
