...
class RespoBusinessOtpVerification extends StatefulWidget {
  RespoBusinessOtpVerification(
      {super.key, this.phoneNumber = '', this.otp = ''});
  String phoneNumber;
  String otp;

  @override
  State<RespoBusinessOtpVerification> createState() =>
      _RespoBusinessOtpVerificationState();
}

class _RespoBusinessOtpVerificationState
    extends State<RespoBusinessOtpVerification> {
  String otpString = "";
        ...
        children: [
          Column(
            children: [
              ...
              InkWell(
                onTap: () {
                  authController.businessloginUsers(
