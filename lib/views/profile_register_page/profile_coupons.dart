              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        Get.find<SubscriptionApiController>()
                            .redeemgetCoupons();
                        setState(() {
                  ...
                  return Container(
                    ...
                    child: couponController.couponsdatalist.isEmpty
                        ...
                        : GridView.builder(
                            shrinkWrap: true,
                            itemCount:
                                couponController.categorycouponsData.length,
                        ...
                        return Container(
                          ...
                          child: couponController.redeemcouponsData.isEmpty
                              ...
                              : GridView.builder(
                                  ...
                                  shrinkWrap: true,
                                  itemCount:
                                      couponController.redeemcouponsData.length,
                                  itemBuilder: (context, index) {
                                    return Padding(
                                        padding: const EdgeInsets.all(15),
                                        child: Container(
