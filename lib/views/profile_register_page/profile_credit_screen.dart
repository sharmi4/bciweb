                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text('₹${settingController.creditLimit.value}',
                                      style: TextStyle(
                                        fontSize: 18,
                                        color: kblue,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        children: [
                                          ...
                                          Text('₹${settingController.usedLimit.value}',
                                          style: TextStyle(
                                            fontSize: 18,
                                            color: kblue,
                                            fontWeight: FontWeight.w500
                                        ...
                                        children: [
                                          ...
                                          Text('₹${settingController.pendingLimit.value}',
                                          style: TextStyle(
                                            fontSize: 18,
                                            color: kblue,
                                            fontWeight: FontWeight.w500
                                ...
                                children: [
                                  ...
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      ...
                                      Text(
                                        formatDate(settingController.creditTransactionsList.first.transactionDate, 
                                        [dd,' ',MM,' ',yyyy]),
                                    ...
                                    children: [
                                      ...
                                      Text('₹${settingController.totalUnpaidAmountCurrentMonth}',
                                      style: TextStyle(
                                        fontSize: 17,
                                        color: kblue,
                                        fontWeight: FontWeight.w500
                                    ...
                                    children: [
                                      Container(
                                        width: 300,
                                        child: Text('Billing information can be defined as any data that enables any person to access a customer or donor"s account. These accounts could be a credit card, checking account, savings account or any similar account. It could also .',
                                        style: TextStyle(
                                          height: 1.3,
                                          color: kblue
                                        ),),
                                   ...
                                   Row(
                                    ...
                                    children: [
                                      InkWell(
                                        onTap: (){
                                          settingController.initiatePayment(amount: double.parse(settingController.totalUnpaidAmountCurrentMonth.value));
                                        },
                                        child: Container(
                                          height: 40,
                                          width: 100,
