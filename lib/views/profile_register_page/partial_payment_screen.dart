...
import 'package:bciweb/views/profile_register_page/deposite_partial_payment_screen.dart';
...
class PartialPaymentScreen extends StatefulWidget {
  const PartialPaymentScreen({super.key});
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        Get.to(const DeposiePartialPayment());
                        // Get.to(
                        //   Payment(
                        //       image: subscriptionapiController
                        //           .plansdataList[temindex].cardImg,
